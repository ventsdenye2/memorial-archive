...
namespace MemorialArchive.Gameplay.Character.Logic
{
    ...
    public sealed class CharacterSystem : IGameSystem, ITickableSystem, ISaveModule
    {
        ...
        public void Tick(float dt)
        {
            ...
            var drains = IsRunning && moveDirection.sqrMagnitude > 0 || IsBlocking; exactStamina = Mathf.Clamp(exactStamina + (drains ? -2 : 1) * dt, 0, attributes?.MaxStamina ?? 30);
        ...
        private void OnPrimary(PrimaryActionPressedEvent e)
        {
            ...
            exactStamina -= config.StaminaCost;
